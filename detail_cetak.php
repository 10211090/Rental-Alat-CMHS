...
$kode=$_GET['kode'];
$sql1 	= "SELECT booking.*,alat.*, merek.*, users.* FROM booking,alat,merek,users WHERE booking.id_alat=alat.id_alat 
			AND merek.id_jenis=alat.id_jenis and booking.email=users.email and booking.kode_booking='$kode'";
...
<head>
	...
	<meta name="description" content="rental alat">
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>Rental Alat Berat</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center"><h2>Rental Alat Berat</h2></td>
					</tr>
					<tr>
						<td class="text-center">Kompleks Balikpapan Baru Sentra Eropa III, Blok AC1 No. 11 dan 25, Balikpapan - Kalimantan Timur</td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
			...
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						<td>Alat</td>
						<td>:</td>
						<td><?php echo $result['nama_jenis'];echo  ", "; echo $result['nama_alat']; ?></td>
					</tr>
					<tr>
						<td>Tanggal Mulai</td>
						<td>:</td>
