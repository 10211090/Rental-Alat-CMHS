...
<head>
	...
	<title>PT. Catur Manunggal Hidup Sejahtera | Admin Edit Merek</title>
...
function valid(theform)
{
		...
		alert ('Hanya huruf yang diperbolehkan untuk Jenis!');
		theform.brand.focus();
		return false;
		}
		return (true);
						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									...
									<?php
									$id=$_GET['id'];
									$sql ="SELECT * FROM merek WHERE id_jenis='$id'";
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" value="<?php echo htmlentities($result['nama_jenis']);?>" name="brand" id="brand" required>
