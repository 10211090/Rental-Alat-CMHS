...
$akhir=$_GET['akhir'];
$stt	 = "Selesai";
$sqlsewa = "SELECT booking.*,alat.*,merek.*,users.* FROM booking,alat,merek,users WHERE booking.id_alat=alat.id_alat
			AND merek.id_jenis=alat.id_jenis AND users.email=booking.email AND booking.status='$stt' 
