...
if(isset($_POST['update'])){
	...
	$sql="update alat set image2='$image2' where id_alat='$id'";
...
<head>
	...
	<title>PT. Catur Manunggal Hidup Sejahtera | Admin Update Image 2</title>
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<label class="col-sm-4 control-label">Gambar Alat 2 Sekarang</label>
												...
												$sql ="SELECT image2 from alat where id_alat='$id'";
												$query	= mysqli_query($koneksidb, $sql);
												$cnt=1;
