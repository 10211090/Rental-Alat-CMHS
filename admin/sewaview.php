...
if($_GET) {
	...
	$sqlsewa = "SELECT booking.*,alat.*,merek.*,users.* FROM booking,alat,merek,users WHERE booking.id_alat=alat.id_alat
				AND merek.id_jenis=alat.id_jenis AND users.email=booking.email AND booking.kode_booking='$Kode'";
...
<table width="100%">
	...
	<tr>
		<td width="20%"><b>Alat</b></td>
		<td width="2%"><b>:</b></td>
		<td width="78%"><?php echo $result['nama_jenis'];?>, <?php echo $result['nama_alat'];?></td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
