...
<head>
	...
	<title>PT. Catur Manunggal Hidup Sejahtera | Admin Kelola Sewa   </title>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
										...
										$sqlsewa = "SELECT booking.*,alat.*,merek.*,users.* FROM booking,alat,merek,users WHERE booking.id_alat=alat.id_alat
													AND merek.id_jenis=alat.id_jenis AND users.email=booking.email AND status='Sudah Dibayar'
