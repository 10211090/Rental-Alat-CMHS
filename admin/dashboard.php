...
<head>
	...
	<title>PT. Catur Manunggal Hidup Sejahtera | Admin Dashboard</title>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
												<?php 
												$sql3 = "SELECT id_jenis FROM merek";
												...
												?>
													...
													<div class="stat-panel-title text-uppercase">Total Jenis</div>
												</div>
											</div>
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											...
											<a href="alat.php" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
