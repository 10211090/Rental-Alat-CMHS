...
<head>
	...
	<title>PT. Catur Manunggal Hidup Sejahtera | Admin Laporan</title>
						...
						<?php
							if(isset($_GET['submit'])){
								...
								$sqlsewa = "SELECT booking.*,alat.*,merek.*,users.* FROM booking,alat,merek,users WHERE booking.id_alat=alat.id_alat
											AND merek.id_jenis=alat.id_jenis AND users.email=booking.email AND booking.bukti_bayar IS NOT NULL AND booking.status !='Menunggu Konfirmasi' AND booking.status != 'Cancel' 
