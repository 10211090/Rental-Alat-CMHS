...
<head>
	...
	<title>PT. Catur Manunggal Hidup Sejahtera | Admin Edit Sewa alat</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Pengembalian Alat</h2>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										$sqlsewa = "SELECT booking.*,alat.*,merek.*,users.* FROM booking,alat,merek,users WHERE booking.id_alat=alat.id_alat
													AND merek.id_jenis=alat.id_jenis AND users.email=booking.email AND booking.kode_booking ='$id'";
									...
									<div class="panel-heading">Detail Sewa</div>
										...
										<form>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="namaalat" class="form-control" value="<?php echo $result['nama_alat'];?>" required readonly>
												</div>
											</div>
											<br/>
											<div class="form-group">
