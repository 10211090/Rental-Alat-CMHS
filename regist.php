...
<title>PT. Catur Manunggal Hidup Sejahtera | Registrasi</title>
<!--Bootstrap -->
      ...
      <div class="user_profile_info">
		...
		<div class="col-md-12 col-sm-10">
              <form  method="post" name="theform" action="registact.php" id="theform" onSubmit="return checkLetter(this);" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <input type="password" class="form-control" id="pass" name="pass" placeholder="Password" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" title="Password harus memiliki karakter Uppercase, Lowercase, Angka dan minimal panjang password 8 karakter" minlenght="8" required="required">
                </div>
                <div class="form-group">
                  <input type="password" class="form-control" id="conf" name="conf" placeholder="Konfirmasi Password" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" title="Password harus memiliki karakter Uppercase, Lowercase, Angka dan minimal panjang password 8 karakter" minlenght="8" required="required">
                </div>
